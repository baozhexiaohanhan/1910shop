            ...
            @foreach($res as $v)
				<div class="col s6">
					<div class="content">
						...
						<h6><font color="#ff7f50">{{$v['goods_name']}}</font></h6>
						<div class="price">
                            $<font color="#8b008b">{{$v['goods_price']}}</font>
						</div>
						<button class="btn button-default"><a href="/cart"><font color="#ff7f50">添加购物车</font></a></button>
					</div>
				</div>
            @endforeach
			</div>
